...
# change these line of code to display more user attribute: 67 69 101 120 121 123 178
class GetADUsers:
    def __init__(self, username, password, domain, cmdLineOptions):
        ...
        self.__header = ["Name", "Email", "Description", "PasswordLastSet", "LastLogon"]
        # Since we won't process all rows at once, this will be fixed lengths
        self.__colLen = [20, 30, 30, 19, 19]
    ...
    def processRecord(self, item):
        ...
        try:
            ...
            print((self.__outputFormat.format(*[sAMAccountName, mail, description, pwdLastSet, lastLogon])))
    ...
    def run(self):
        ...
        try:
            ...
            ldapConnection.search(searchFilter=searchFilter,
                                  attributes=['sAMAccountName', 'pwdLastSet', 'mail', 'description', 'lastLogon'],
