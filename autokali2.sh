...
echo -e "${Green}===Install EyeWitness===${Color_Off}"
echo -e "${Green}cd /home/kali/Toys/EyeWitness/Python/setup${Color_Off}"
echo -e "${Green}sudo setup.sh${Color_Off}"
echo -e "${Green}To run EyeWitness: /home/kali/Toys/EyeWitness/Python/EyeWitness.py${Color_Off}"